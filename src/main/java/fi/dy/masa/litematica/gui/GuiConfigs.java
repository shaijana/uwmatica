...
//        x += this.createButton(x, y, -1, ConfigGuiTab.TEST);
    ...
    public List<ConfigOptionWrapper> getConfigs()
    {
        ...
        {
            configs = AllowedFunctionsHandler.ALLOWED_GENERIC_CONFIGS; //Shaijana
        }
        ...
        {
            configs = AllowedFunctionsHandler.ALLOWED_VISUALS_CONFIGS; //Shaijana
        }
        else if (tab == ConfigGuiTab.COLORS)
        {
            configs = AllowedFunctionsHandler.ALLOWED_COLORS_CONFIGS; //Shaijana
        }
        else if (tab == ConfigGuiTab.HOTKEYS)
        {
            configs = AllowedFunctionsHandler.ALLOWED_HOTKEYS; //Shaijana
        }
...
//        }
    ...
    public List<ConfigOptionWrapper> getAllConfigs()
    {
        ...
        configs.addAll(ConfigOptionWrapper.createFor(AllowedFunctionsHandler.ALLOWED_GENERIC_CONFIGS)); //Shaijana
        configs.addAll(ConfigOptionWrapper.createFor(Configs.InfoOverlays.OPTIONS));
        configs.addAll(ConfigOptionWrapper.createFor(AllowedFunctionsHandler.ALLOWED_VISUALS_CONFIGS)); //Shaijana
        configs.addAll(ConfigOptionWrapper.createFor(AllowedFunctionsHandler.ALLOWED_COLORS_CONFIGS)); //Shaijana));
        configs.addAll(ConfigOptionWrapper.createFor(AllowedFunctionsHandler.ALLOWED_HOTKEYS)); //Shaijana));
