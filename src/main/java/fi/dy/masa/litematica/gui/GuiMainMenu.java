...
//SH        this.createChangeMenuButton(x, y, width, ButtonListenerChangeMenu.ButtonType.TASK_MANAGER);

//SH        if (Configs.Generic.UNHIDE_SCHEMATIC_PROJECTS.getBooleanValue())
//SH        {
//SH            y += 22;
