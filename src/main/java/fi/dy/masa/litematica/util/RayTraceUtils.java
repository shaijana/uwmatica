...
public class RayTraceUtils
{
    ...
    public static @Nullable RayTraceUtils.InventoryPreviewData getTargetInventory(MinecraftClient mc, World world, @Nullable BlockPos pos)
    {
        ...
        if (trace.getType() == HitResult.Type.BLOCK)
        {
            BlockPos tracePos = ((BlockHitResult) trace).getBlockPos();
            if (pos == null)
            {
                pos = tracePos;
            }
    ...
    public static InventoryPreviewData getTargetInventoryFromEntity(Entity entity)
    {
        ...
        {
            inv = ((IMixinAbstractHorseEntity) entity).litematica_getHorseInventory();
        }
        else if (entity instanceof PiglinEntity)
        {
            inv = ((IMixinPiglinEntity) entity).litematica_inventory();
        }
