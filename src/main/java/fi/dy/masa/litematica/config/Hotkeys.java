...
public class Hotkeys
{
    ...
    public static final ConfigHotkey SCHEMATIC_EDIT_BREAK_ALL_EXCEPT    = new ConfigHotkey("schematicEditBreakAllExcept",       "", KeybindSettings.MODIFIER_INGAME, "litematica.config.hotkeys.comment.schematicEditBreakAllExcept").translatedName("litematica.config.hotkeys.name.schematicEditBreakAll");
    ...
    public static final ConfigHotkey TOGGLE_AREA_SELECTION_RENDERING    = new ConfigHotkey("toggleAreaSelectionBoxesRendering", "",     "litematica.config.hotkeys.comment.toggleAreaSelectionBoxesRendering").translatedName("litematica.config.hotkeys.name.toggleAreaSelection");
    ...
    public static final ConfigHotkey TOOL_ENABLED_TOGGLE                = new ConfigHotkey("toolEnabledToggle",                 "M,T",  "litematica.config.hotkeys.comment.toolEnabledToggle").translatedName("litematica.config.hotkeys.name.toggleEnabledToggle");
    public static final ConfigHotkey TOOL_PLACE_CORNER_1                = new ConfigHotkey("toolPlaceCorner1",                  "BUTTON_1", KeybindSettings.PRESS_ALLOWEXTRA, "litematica.config.hotkeys.comment.toolPlaceCorner1").translatedName("litematica.config.hotkeys.name.togglePlaceCorner1");
    public static final ConfigHotkey TOOL_PLACE_CORNER_2                = new ConfigHotkey("toolPlaceCorner2",                  "BUTTON_2", KeybindSettings.PRESS_ALLOWEXTRA, "litematica.config.hotkeys.comment.toolPlaceCorner2").translatedName("litematica.config.hotkeys.name.togglePlaceCorner2");
    public static final ConfigHotkey TOOL_SELECT_ELEMENTS               = new ConfigHotkey("toolSelectElements",                "BUTTON_3", KeybindSettings.PRESS_ALLOWEXTRA, "litematica.config.hotkeys.comment.toolSelectElements").translatedName("litematica.config.hotkeys.name.toggleSelectElements");
    public static final ConfigHotkey TOOL_SELECT_MODIFIER_BLOCK_1       = new ConfigHotkey("toolSelectModifierBlock1",          "LEFT_ALT", KeybindSettings.MODIFIER_INGAME, "litematica.config.hotkeys.comment.toolSelectModifierBlock1").translatedName("litematica.config.hotkeys.name.toggleSelectModifierBlock1");
    public static final ConfigHotkey TOOL_SELECT_MODIFIER_BLOCK_2       = new ConfigHotkey("toolSelectModifierBlock2",          "LEFT_SHIFT", KeybindSettings.MODIFIER_INGAME, "litematica.config.hotkeys.comment.toolSelectModifierBlock2").translatedName("litematica.config.hotkeys.name.toggleSelectModifierBlock2");
