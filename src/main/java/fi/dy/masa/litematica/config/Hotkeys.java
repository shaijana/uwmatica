...
public class Hotkeys
{
    ...
    public static final ConfigHotkey SCHEMATIC_VERSION_CYCLE_PREVIOUS   = new ConfigHotkey("schematicVersionCyclePrevious",     "",     "litematica.config.hotkeys.comment.schematicVersionCyclePrevious").translatedName("litematica.config.hotkeys.name.schematicCyclePrevious");
