...
//SH        public static final ConfigInteger       COMMAND_FILL_MAX_VOLUME     = new ConfigInteger("commandFillMaxVolume", 32768, 256, 10000000, "The maximum size/volume of each individual box\nthat can be filled via the command-based Fill/Delete\noperations. Bigger areas/volumes will get split to multiple commands.\nAll areas are also split to per-chunk boxes at first anyway.");
//SH        public static final ConfigBoolean       COMMAND_FILL_NO_CHUNK_CLAMP = new ConfigBoolean("commandFillNoChunkClamp", false, "Disables dividing the fill volumes (in the Fill, Replace and Delete modes)\nto per-chunk boxes");
//SH        public static final ConfigInteger       COMMAND_LIMIT               = new ConfigInteger("commandLimitPerTick", 24, 1, 256, "Maximum number of commands sent per game tick,\nwhen using the Paste, Fill and Delete features on a server,\nwhere they will use setblock and fill commands.\nNote that he Paste feature can overshoot this by a couple of commands\nwhen using the NBT restore functionality, which needs two additional commands for each block.");
...
//SH        public static final ConfigBoolean       PASTE_ALWAYS_USE_FILL       = new ConfigBoolean("pasteAlwaysUseFill", false, "This forces using the fill command (instead of setblock) even for single blocks");
...
//SH        public static final ConfigBoolean       PASTE_USING_COMMANDS_IN_SP  = new ConfigBoolean("pasteUsingCommandsInSp", false, "This is a temporary hack workaround to use the command-based pasting\nalso in single player, which allows using the render layer limited\npasting in single player, which currently doesn't work with\nthe direct world access pasting that single player normally uses.\n\nNote that this will have all the same NBT data restoration\nlimitations that multiplayer pasting has normally.");
//SH        public static final ConfigBoolean       PICK_BLOCK_AVOID_DAMAGEABLE = new ConfigBoolean("pickBlockAvoidDamageable", true, "Avoids replacing any damageable items in the hotbar");
//SH        public static final ConfigBoolean       PICK_BLOCK_AVOID_TOOLS      = new ConfigBoolean("pickBlockAvoidTools", false, "Avoids replacing any tool items in the hotbar.\n\nThis means any items that extend the vanilla ToolItem class.");
...
//SH                CLONE_AT_ORIGINAL_POS,
//SH                COMMAND_DISABLE_FEEDBACK,
//SH                COMMAND_FILL_NO_CHUNK_CLAMP,
//SH                COMMAND_USE_WORLDEDIT,
                CUSTOM_SCHEMATIC_BASE_DIRECTORY_ENABLED,
                DEBUG_LOGGING,
//SH                EASY_PLACE_FIRST,
//SH                EASY_PLACE_HOLD_ENABLED,
//SH                EASY_PLACE_MODE,
//SH                EASY_PLACE_SP_HANDLING,
//SH                EASY_PLACE_PROTOCOL,
//SH                EASY_PLACE_VANILLA_REACH,
//SH                EXECUTE_REQUIRE_TOOL,
                FIX_CHEST_MIRROR,
                FIX_RAIL_ROTATION,
...
//SH                PASTE_ALWAYS_USE_FILL,
//SH                PASTE_IGNORE_BE_ENTIRELY,
//SH                PASTE_IGNORE_BE_IN_FILL,
//SH                PASTE_IGNORE_CMD_LIMIT,
//SH                PASTE_IGNORE_ENTITIES,
//SH                PASTE_IGNORE_INVENTORY,
//SH                PASTE_NBT_BEHAVIOR,
//SH                PASTE_TO_MCFUNCTION,
//SH                PASTE_USE_FILL_COMMAND,
//SH                PASTE_USING_COMMANDS_IN_SP,
//SH                PICK_BLOCK_AVOID_DAMAGEABLE,
//SH                PICK_BLOCK_AVOID_TOOLS,
//SH                PICK_BLOCK_ENABLED,
//SH                PICK_BLOCK_SHULKERS,
//SH                PLACEMENT_REPLACE_BEHAVIOR,
//SH                PLACEMENT_RESTRICTION,
//SH                PLACEMENT_RESTRICTION_WARN,
...
//SH                PASTE_COMMAND_INTERVAL,
//SH                PASTE_COMMAND_LIMIT,
//SH                PASTE_COMMAND_SETBLOCK,
//SH                PICK_BLOCKABLE_SLOTS,
//SH                COMMAND_FILL_MAX_VOLUME,
//SH                COMMAND_LIMIT,
//SH                COMMAND_NAME_CLONE,
//SH                COMMAND_NAME_FILL,
//SH                COMMAND_NAME_SETBLOCK,
//SH                COMMAND_NAME_SUMMON,
//SH                COMMAND_TASK_INTERVAL,
                CUSTOM_SCHEMATIC_BASE_DIRECTORY,
//SH                EASY_PLACE_SWAP_INTERVAL,
//SH                PICK_BLOCKABLE_SLOTS,
                TOOL_ITEM
        );
    }
    ...
    {
//SH        public static final ConfigBoolean       ENABLE_AREA_SELECTION_RENDERING     = new ConfigBoolean("enableAreaSelectionBoxesRendering", true, "Enable Area Selection boxes rendering", "Area Selection Boxes Rendering");
//SH        public static final ConfigBoolean       ENABLE_PLACEMENT_BOXES_RENDERING    = new ConfigBoolean("enablePlacementBoxesRendering", true, "Enable Schematic Placement boxes rendering", "Schematic Placement Boxes Rendering");
...
//SH        public static final ConfigDouble        PLACEMENT_BOX_SIDE_ALPHA            = new ConfigDouble( "placementBoxSideAlpha", 0.2, 0, 1, "The alpha value of the sub-region boxes' side");
//SH        public static final ConfigBoolean       RENDER_AREA_SELECTION_BOX_SIDES     = new ConfigBoolean("renderAreaSelectionBoxSides", true, "If enabled, then the area selection boxes will\nhave their side quads rendered");
...
//SH        public static final ConfigBoolean       RENDER_PLACEMENT_BOX_SIDES          = new ConfigBoolean("renderPlacementBoxSides", false, "If enabled, then the placed schematic sub-region boxes\nwill have their side quads rendered");
//SH        public static final ConfigBoolean       RENDER_PLACEMENT_ENCLOSING_BOX      = new ConfigBoolean("renderPlacementEnclosingBox", true, "If enabled, then an enclosing box is rendered around\nall the sub-regions in a schematic (placement)");
//SH        public static final ConfigBoolean       RENDER_PLACEMENT_ENCLOSING_BOX_SIDES= new ConfigBoolean("renderPlacementEnclosingBoxSides", false, "If enabled, then the enclosing box around\na schematic placement will have its side quads rendered");
...
//SH                PLACEMENT_BOX_SIDE_ALPHA,
    ...
    {
//SH        public static final ConfigColor AREA_SELECTION_BOX_SIDE_COLOR       = new ConfigColor("areaSelectionBoxSideColor",          "#30FFFFFF", "The color of the area selection boxes, when they are unselected");
//SH        public static final ConfigColor HIGHTLIGHT_BLOCK_IN_INV_COLOR       = new ConfigColor("hightlightBlockInInventoryColor",    "#30FF30FF", "The highlight color for the item of the looked at block");
...
//SH        public static final ConfigColor REBUILD_BREAK_OVERLAY_COLOR         = new ConfigColor("schematicRebuildBreakPlaceOverlayColor", "#4C33CC33", "The color of Schematic Rebuild mode's break or place blocks selector overlay");
//SH        public static final ConfigColor REBUILD_BREAK_EXCEPT_OVERLAY_COLOR  = new ConfigColor("schematicRebuildBreakExceptPlaceOverlayColor", "#4CF03030", "The color of Schematic Rebuild mode's break all blocks except targeted selector overlay");
//SH        public static final ConfigColor REBUILD_REPLACE_OVERLAY_COLOR       = new ConfigColor("schematicRebuildReplaceOverlayColor","#4CF0A010", "The color of Schematic Rebuild mode's replace selector overlay");
        ...
        public static final ImmutableList<IConfigBase> OPTIONS = ImmutableList.of(
//SH                AREA_SELECTION_BOX_SIDE_COLOR,
//SH                HIGHTLIGHT_BLOCK_IN_INV_COLOR,
                MATERIAL_LIST_HUD_ITEM_COUNTS,
//SH                REBUILD_BREAK_OVERLAY_COLOR,
//SH                REBUILD_BREAK_EXCEPT_OVERLAY_COLOR,
//SH                REBUILD_REPLACE_OVERLAY_COLOR,
...
//SH        InventoryUtils.setPickBlockableSlots(Generic.PICK_BLOCKABLE_SLOTS.getStringValue());
    }
