...
public class Configs implements IConfigHandler
{
    ...
    public static class Visuals
    {
        ...
        public static final ConfigBoolean       SCHEMATIC_OVERLAY_ENABLE_RESORTING  = new ConfigBoolean("schematicOverlayEnableResorting",  true, "Enables Translucent Sorting for\nthe schematic block overlay", "Schematic Overlay Translucent Sorting");
