...
//        list.add(BlockRenderLayer.CUTOUT_MIPPED);
    ...
    private static List<RenderLayer> getRenderLayers()
    {
		...
		// Blocks?
	    list.add(RenderLayers.solid());
	    list.add(RenderLayers.cutout());
	    list.add(RenderLayers.translucentMovingBlock());
	    list.add(RenderLayers.tripwire());
	    list.add(RenderLayers.endPortal());
	    list.add(RenderLayers.endGateway());

        // Water Rendering
        list.add(RenderLayers.waterMask());
